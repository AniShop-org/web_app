      ...
      <div className="flex-grow container mx-auto px-4 lg:px-8 py-6 flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-grow">
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center md:gap-4 gap-2 pb-4">
              <button
                onClick={() => router.back()}
          ...
          <div className="md:pt-8 pt-3 flex justify-between sm:gap-4 gap-2">
            <button
              className="border border-[#FFFFFF] rounded-full text-xs md:text-sm lg:p-2 p-2 lg:px-20 px-4"
            ...
            <button
              className="bg-[#FF3333] rounded-full lg:p-3 lg:px-20 md:px-8 px-4 sm:p-2 p-2 text-xs md:text-sm"
              onClick={() => {
                router.push("/cart");
              }}
            >
